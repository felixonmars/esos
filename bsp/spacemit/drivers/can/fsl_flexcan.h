...
#define FSL_FEATURE_FLEXCAN_HAS_MESSAGE_BUFFER_MAX_NUMBER (14)
...
#define CAN_WORD1_COUNT                         (14U)

#define CAN_RAM_SIZE                            0x400
...
{
    kStatus_FLEXCAN_TxBusy = 0, /*!< Tx Message Buffer is Busy. */
...
typedef void (*flexcan_transfer_callback_t)(
    CAN_Type *base, flexcan_handle_t *handle, int32_t status, uint32_t result, void *userData);
 ...
 */
void FLEXCAN_FDInit(
    CAN_Type *base, const flexcan_config_t *config, uint32_t sourceClock_Hz, bool brs);
#endif
 ...
 */
int32_t FLEXCAN_WriteTxMb(CAN_Type *base, uint8_t mbIdx, const flexcan_frame_t *txFrame);
 ...
 */
int32_t FLEXCAN_ReadRxMb(CAN_Type *base, uint8_t mbIdx, flexcan_frame_t *rxFrame);
 ...
 * @retval kStatus_Fail    - Tx Message Buffer is currently in use.
 */
int32_t FLEXCAN_WriteFDTxMb(CAN_Type *base, uint8_t mbIdx, const flexcan_fd_frame_t *txFrame);
 ...
 * @retval kStatus_Fail               - Rx Message Buffer is empty.
 */
int32_t FLEXCAN_ReadFDRxMb(CAN_Type *base, uint8_t mbIdx, flexcan_fd_frame_t *rxFrame);
#endif
 ...
 */
int32_t FLEXCAN_ReadRxFifo(CAN_Type *base, flexcan_frame_t *rxFrame);
 ...
 * @retval kStatus_Fail    - Tx Message Buffer is currently in use.
 */
int32_t FLEXCAN_TransferFDSendBlocking(CAN_Type *base, uint8_t mbIdx, flexcan_fd_frame_t *txFrame);
 ...
 * @retval kStatus_Fail               - Rx Message Buffer is empty.
 */
int32_t FLEXCAN_TransferFDReceiveBlocking(CAN_Type *base, uint8_t mbIdx, flexcan_fd_frame_t *rxFrame);
 ...
 */
int32_t FLEXCAN_TransferFDSendNonBlocking(CAN_Type *base, flexcan_handle_t *handle, flexcan_mb_transfer_t *xfer);
 ...
 */
int32_t FLEXCAN_TransferFDReceiveNonBlocking(CAN_Type *base, flexcan_handle_t *handle, flexcan_mb_transfer_t *xfer);
 ...
 * @retval kStatus_Fail    - Tx Message Buffer is currently in use.
 */
int32_t FLEXCAN_TransferSendBlocking(CAN_Type *base, uint8_t mbIdx, flexcan_frame_t *txFrame);
 ...
 * @retval kStatus_Fail               - Rx Message Buffer is empty.
 */
int32_t FLEXCAN_TransferReceiveBlocking(CAN_Type *base, uint8_t mbIdx, flexcan_frame_t *rxFrame);
 ...
 * @retval kStatus_Fail    - Rx FIFO is not enabled.
 */
int32_t FLEXCAN_TransferReceiveFifoBlocking(CAN_Type *base, flexcan_frame_t *rxFrame);
 ...
 * @retval kStatus_FLEXCAN_TxBusy Tx Message Buffer is in use.
 */
int32_t FLEXCAN_TransferSendNonBlocking(CAN_Type *base, flexcan_handle_t *handle, flexcan_mb_transfer_t *xfer);
 ...
 * @retval kStatus_FLEXCAN_RxBusy - Rx Message Buffer is in use.
 */
int32_t FLEXCAN_TransferReceiveNonBlocking(CAN_Type *base, flexcan_handle_t *handle, flexcan_mb_transfer_t *xfer);
 ...
 */
int32_t FLEXCAN_TransferReceiveFifoNonBlocking(CAN_Type *base,
                                               flexcan_handle_t *handle,
...
void CAN_DriverIRQHandler(rt_int32_t vector, void *param);
