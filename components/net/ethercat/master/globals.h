...
/*****************************************************************************
 * EtherCAT protocol parameters
 ****************************************************************************/

/* Size of an EtherCAT frame header. */
#define EC_FRAME_HEADER_SIZE 2

/* Working counter size of an EtherCAT frame. */
#define EC_FRAME_WC_SIZE 2

/* Status size of an EtherCAT frame. */
#define EC_FRAME_STATUS_SIZE 2
...
/*****************************************************************************
 * Debug macros adapted to RT-Thread logging
 ****************************************************************************/

/** Convenience macro for printing EtherCAT-specific information to the console.
 *
...
#define EC_INFO(fmt, args...) \
	rt_kprintf("EtherCAT: " fmt, ##args)

/** Convenience macro for printing EtherCAT-specific errors to the console.
 *
...
#define EC_ERR(fmt, args...) \
	rt_kprintf("EtherCAT ERROR: " fmt, ##args)

/** Convenience macro for printing EtherCAT-specific warnings to the console.
 *
...
#define EC_WARN(fmt, args...) \
	rt_kprintf("EtherCAT WARNING: " fmt, ##args)

/** Convenience macro for printing EtherCAT debug messages to the console.
 *
...
#define EC_DBG(fmt, args...) \
	rt_kprintf("EtherCAT DEBUG: " fmt, ##args)
...
int ec_mac_print(const uint8_t *, char *);
